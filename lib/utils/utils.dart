...
/*
Different from tutorial 16 Booking slot Fix - following date condition added-
context.read(selectedDate).state.day == DateTime.now().day
-to the GridView.builder of displayTimeSlot method
*/
Future<int> getNearestAvailableTimeSlot() async {
